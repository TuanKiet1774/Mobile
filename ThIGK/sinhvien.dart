      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: Obx(() => ListView.separated(
                itemBuilder: (context, index) {
                  return Container(
                    child: ListTile(
                      title: Text(ds.dsmh[index].monHoc, style: TextStyle(fontSize: 20),),
            ...
            Row(
              children: [
                Text("Danh sach có: " + "2" + "" + " môn học", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),)
              ],
            )
          ],
        ),
